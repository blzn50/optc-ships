...
export const details: Record<number, ShipInfo> = {
  ...
  45: {
    ...
    specialEffect1: 'Reduces Special charge time by 1 turn at start of quest',
    specialEffect2:
      "Boosts top-row characters' ATK by 1.7x, and reduces the duration of [HEAL_TO_DAMAGE] effect by 1 turn [Updated Special] (8 turns): Reduces crew's Slot Bind duration by 2 turns, changes crew's [BLOCK] slots to Rainbow slots (doubling ATK; cannot be changed by crew or enemies), and locks crew's slots for 2 turns",
    modification: {
      phase: [1, 2],
      effect: [
        ...
        "Reduces Special charge time by 1 turn at start of quest, reduces the duration of [HEAL_TO_DAMAGE] effect by 1 turn, boosts crew's HP by 1.4x, and if Captain is a PSY or INT type, boosts top-row characters' ATK by 1.7x, boosts middle and bottom-row characters' ATK by 1.8x, boosts Captain's RCV by 600, and reduces damage taken by 15%",
      ],
      cd: [8, 8],
      special: [
        "Reduces crew's Slot Bind duration by 1 turn and locks crew's slots for 2 turns",
  ...
  70: {
    ...
    obtain: 'From the 3rd step of 12th Anniversary Super Sugo-Fest! (Part 1)',
    cola: [0, 5, 9, 16, 26, 36, 56, 86, 116, 150, 5000, 10000],
    superCola: [0, 0, 0, 0, 0, 0, 0, 0, 0, 5, 15],
    note: 'The effect of ship level 1-9 are assumed values. It will be updated after checking the ship data when it is available.',
    effect: [
      "Boosts DEX and Fighter characters' ATK by 1.2x",
      "Boosts DEX and Fighter characters' HP by 1.1x and ATK by 1.2x",
      "Boosts DEX and Fighter characters' HP by 1.1x and ATK by 1.3x",
      "Boosts DEX and Fighter characters' HP by 1.2x and ATK by 1.3x",
      "Boosts DEX and Fighter characters' HP by 1.3x and ATK by 1.4x",
      "Boosts DEX and Fighter characters' HP by 1.3x and ATK by 1.5x",
      "Boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x",
      "Boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts [Straw Hat Pirates] characters' ATK by a further 1.1x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x. If 3 or more [Straw Hat Pirates] [Four Emperors] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x. If 3 or more [Straw Hat Pirates] [Four Emperors] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.2x. If 3 or more [Straw Hat Pirates] [Four Emperors] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.2x. If 3 or more [Straw Hat Pirates] [Four Emperors] characters are on the crew, boosts DEX, Fighter, and [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.2x",
    ],
    cd: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 13],
    specialEffect1:
      "Boosts DEX-type Fighter characters' ATK by a further 1.3x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts DEX, Fighter, and [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.3x",
    specialEffect2:
      "Reduces Special charge time by a further 1 turn at start of quest if a character's 1st class is Free Spirit. If 4 or more [Straw Hat Pirates] [Four Emperors] characters are on the crew and crew uses a Special to increase enemies' damage taken, further increases the effect by +0.1 (stackable with other further raising effects) / Special (13 turns): Reduces DEX characters' Special charge time by 1 turn, changes bottom-row characters' slots to [RCV], and if Captain is a [Straw Hat Pirates] [Four Emperors] character, applies -15% Fighter Resistance to all enemies for 1 turn",
    modification: {
      phase: [1, 2],
      effect: [
        "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.3x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts DEX, Fighter, and [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.3x",
  ...
  71: {
    ...
    superCola: [0, 0, 0, 0, 0, 0, 0, 0, 0, 5, 15],
    effect: [
      "Boosts QCK and Free Spirit characters' ATK by 1.2x",
      "Boosts QCK and Free Spirit characters' HP by 1.2x and ATK by 1.2x",
      "Boosts QCK and Free Spirit characters' HP by 1.2x and ATK by 1.3x",
      "Boosts QCK and Free Spirit characters' HP by 1.3x and ATK by 1.3x",
      "Boosts QCK and Free Spirit characters' HP by 1.4x and ATK by 1.4x",
      "Boosts QCK and Free Spirit characters' HP by 1.4x and ATK by 1.5x",
      "Boosts QCK and Free Spirit characters' HP by 1.4x, ATK by 1.5x, and boosts QCK-type Free Spirit characters' ATK by a further 1.1x",
      "Boosts QCK and Free Spirit characters' HP by 1.4x, ATK by 1.5x, and boosts QCK-type Free Spirit characters' ATK by a further 1.1x. If 3 or more [Blackbeard Pirates] [Worst Generation] characters are on the crew, boosts [Blackbeard Pirates] [Worst Generation] [Four Emperors] characters' ATK by a further 1.1x",
      "Makes it a little easier to land PERFECT strikes, boosts QCK and Free Spirit characters' HP by 1.4x, ATK by 1.5x, and boosts QCK-type Free Spirit characters' ATK by a further 1.1x. If 3 or more [Blackbeard Pirates] [Worst Generation] characters are on the crew, boosts [Blackbeard Pirates] [Worst Generation] [Four Emperors] characters' ATK by a further 1.1x",
      "Makes it a little easier to land PERFECT strikes, boosts QCK and Free Spirit characters' HP by 1.4x, ATK by 1.5x, and boosts QCK-type Free Spirit characters' ATK by a further 1.1x. If 3 or more [Blackbeard Pirates] [Worst Generation] characters are on the crew, boosts [Blackbeard Pirates] [Worst Generation] [Four Emperors] characters' ATK by a further 1.2x",
      "Makes it a little easier to land PERFECT strikes, boosts QCK and Free Spirit characters' HP by 1.4x, ATK by 1.5x, and boosts QCK-type Free Spirit characters' ATK by a further 1.2x. If 3 or more [Blackbeard Pirates] [Worst Generation] characters are on the crew, boosts [Blackbeard Pirates] [Worst Generation] [Four Emperors] characters' ATK by a further 1.2x",
      "Makes it a little easier to land PERFECT strikes, boosts QCK and Free Spirit characters' HP by 1.4x, ATK by 1.5x, and boosts QCK-type Free Spirit characters' ATK by a further 1.2x. If 3 or more [Blackbeard Pirates] [Worst Generation] characters are on the crew, boosts QCK, Free Spirit, and [Blackbeard Pirates] [Worst Generation] [Four Emperors] characters' ATK by a further 1.2x",
    ],
    cd: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 13],
    specialEffect1:
  ...
  72: {
    ...
    superCola: [0, 0, 0, 0, 0, 0, 0, 0, 0, 5, 15],
    effect: [
      "Boosts INT and Slasher characters' ATK by 1.2x",
      "Boosts INT and Slasher characters' HP by 1.1x and ATK by 1.2x",
      "Boosts INT and Slasher characters' HP by 1.1x and ATK by 1.3x",
      "Boosts INT and Slasher characters' HP by 1.2x and ATK by 1.3x",
      "Boosts INT and Slasher characters' HP by 1.3x and ATK by 1.4x",
      "Boosts INT and Slasher characters' HP by 1.3x and ATK by 1.5x",
      "Boosts INT and Slasher characters' HP by 1.3x, ATK by 1.5x, and boosts INT-type Slasher characters' ATK by a further 1.1x",
      "Boosts INT and Slasher characters' HP by 1.3x, ATK by 1.5x, and boosts INT-type Slasher characters' ATK by a further 1.1x. If 3 or more [Cross Guild] [Four Emperors] characters are on the crew, boosts [Cross Guild] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces INT and Slasher characters' Special charge time by 1 turn at start of quest, boosts INT and Slasher characters' HP by 1.3x, ATK by 1.5x, and boosts INT-type Slasher characters' ATK by a further 1.1x. If 3 or more [Cross Guild] [Four Emperors] characters are on the crew, boosts [Cross Guild] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces INT and Slasher characters' Special charge time by 1 turn at start of quest, boosts INT and Slasher characters' HP by 1.3x, ATK by 1.5x, and boosts INT-type Slasher characters' ATK by a further 1.1x. If 3 or more [Cross Guild] [Four Emperors] characters are on the crew, boosts [Cross Guild] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces INT and Slasher characters' Special charge time by 1 turn at start of quest, boosts INT and Slasher characters' HP by 1.3x, ATK by 1.5x, and boosts INT-type Slasher characters' ATK by a further 1.2x. If 3 or more [Cross Guild] [Four Emperors] characters are on the crew, boosts [Cross Guild] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces INT and Slasher characters' Special charge time by 1 turn at start of quest, boosts INT and Slasher characters' HP by 1.3x, ATK by 1.5x, and boosts INT-type Slasher characters' ATK by a further 1.2x. If 3 or more [Cross Guild] [Four Emperors] characters are on the crew, boosts INT, Slasher, and [Cross Guild] [Four Emperors] characters' ATK by a further 1.2x",
    ],
    cd: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 13],
    specialEffect1:
  ...
  73: {
    ...
    superCola: [0, 0, 0, 0, 0, 0, 0, 0, 0, 5, 15],
    effect: [
      "Boosts STR and Cerebral characters' ATK by 1.2x",
      "Boosts STR and Cerebral characters' HP by 1.1x and ATK by 1.2x",
      "Boosts STR and Cerebral characters' HP by 1.1x and ATK by 1.3x",
      "Boosts STR and Cerebral characters' HP by 1.2x and ATK by 1.3x",
      "Boosts STR and Cerebral characters' HP by 1.3x and ATK by 1.4x",
      "Boosts STR and Cerebral characters' HP by 1.3x and ATK by 1.5x",
      "Boosts STR and Cerebral characters' HP by 1.3x, ATK by 1.5x, and boosts STR-type Cerebral characters' ATK by a further 1.1x",
      "Boosts STR and Cerebral characters' HP by 1.3x, ATK by 1.5x, and boosts STR-type Cerebral characters' ATK by a further 1.1x. If 2 or more [Red-Haired Pirates] characters are on the crew, boosts [Red-Haired Pirates] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces STR and Cerebral characters' Special charge time by 1 turn at start of quest, boosts STR and Cerebral characters' HP by 1.3x, ATK by 1.5x, and boosts STR-type Cerebral characters' ATK by a further 1.1x. If 2 or more [Red-Haired Pirates] characters are on the crew, boosts [Red-Haired Pirates] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces STR and Cerebral characters' Special charge time by 1 turn at start of quest, boosts STR and Cerebral characters' HP by 1.3x, ATK by 1.5x, and boosts STR-type Cerebral characters' ATK by a further 1.1x. If 2 or more [Red-Haired Pirates] characters are on the crew, boosts [Red-Haired Pirates] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces STR and Cerebral characters' Special charge time by 1 turn at start of quest, boosts STR and Cerebral characters' HP by 1.3x, ATK by 1.5x, and boosts STR-type Cerebral characters' ATK by a further 1.2x. If 2 or more [Red-Haired Pirates] characters are on the crew, boosts [Red-Haired Pirates] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces STR and Cerebral characters' Special charge time by 1 turn at start of quest, boosts STR and Cerebral characters' HP by 1.3x, ATK by 1.5x, and boosts STR-type Cerebral characters' ATK by a further 1.2x. If 2 or more [Red-Haired Pirates] characters are on the crew, boosts STR, Cerebral, and [Red-Haired Pirates] [Four Emperors] characters' ATK by a further 1.2x",
    ],
    cd: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 13],
    specialEffect1:
