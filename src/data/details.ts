...
export const details: Record<number, ShipInfo> = {
  ...
  70: {
    ...
    effect: [
      ...
      "Boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.1x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.1x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.2x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.2x",
      "Reduces DEX and Fighter characters' Special charge time by 1 turn at start of quest, boosts DEX and Fighter characters' HP by 1.3x, ATK by 1.5x, and boosts DEX-type Fighter characters' ATK by a further 1.2x. If 3 or more [Straw Hat Pirates] characters are on the crew, boosts DEX, Fighter, and [Straw Hat Pirates] [Four Emperors] characters' ATK by a further 1.2x",
    ],
    cd: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 13],
    specialEffect1:
